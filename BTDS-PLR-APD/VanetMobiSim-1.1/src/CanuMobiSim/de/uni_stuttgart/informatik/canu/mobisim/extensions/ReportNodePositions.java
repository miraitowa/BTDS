...
public class ReportNodePositions extends ExtensionModule
{
  ...
  public void activate()
  {
    ...
    while (iter.hasNext())
    {
      ...
      o.println(node.getID()+" "+(float)u.getTime()/1000+" "+node.getPosition().getX()+" "+node.getPosition().getY());
    }
  }
  ...
  public void load(org.w3c.dom.Element element) throws java.lang.Exception
  {
    u.sendNotification(new LoaderNotification(this, u,
      "Loading ReportNodePositions extension"));
    ...
    u.sendNotification(new LoaderNotification(this, u,
      "Finished loading ReportNodePositions extension"));
  }
}
